...
export const options = {
  stages: [
    { duration: '1m', target: 20 },  // Simula 20 usuários por 30s
    { duration: '5m', target: 35 },   // Aumenta para 500 usuários
...
export default function () {
  ...
  const headers = { 'Content-Type': 'application/json', 'X-Use-ProxySQL': 'true' };
  ...
  const getRes = http.get('http://web:80/volumes/list', { headers });
  check(getRes, {
